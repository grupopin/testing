...
<head>
<title>Fall in Cloud - Fall in Fog - Fall out &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>780 FALL IN CLOUD - FALL IN FOG - FALL OUT</h2><p>Dreidimensionales Objekt, Siebdruck, 1979</p>";	

	var picpath = new Array();
	picpath[0]= "deutsch/werk/ankunst/images/hundertwasser/apa/apa_0158.jpg";	
...
<div id="contentwrapper">
	...
	<h2>FALL IN CLOUD - FALL IN FOG - FALL OUT</h2>
	
	<div class="newsItem alternative">  
	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/apa/apa_0158_sml.jpg" width="250" height="183" alt="" /></a></p>
	<p class="werk">Dreidimensionales Objekt, Siebdruck, 1979</p>
	
	<p>Zur Herstellung dieses Objektes waren 61 Druckvorg&auml;nge n&ouml;tig, davon 29 Siebdrucke in 13 Farben und 32 Metallpr&auml;gungen in 7 Farben. Das dreidimensionale Bild, eine transparente Stadt in leuchtenden Farben und funkelnden Metallen, besteht aus f&uuml;nf Platten aus Plexiglas. Eine gr&uuml;nget&ouml;nte Platte wurde zur Verbesserung des Ferneffektes in der Mitte hinzugef&uuml;gt </p>

	<p>F&uuml;r die Entwicklung des Objektes, die von 1973 bis 1979 dauerte und im Zuge derer eigene Maschinen extra konstruiert werden mu&szlig;ten, stand Hundertwasser als Koordinator Alberto della Vecchia zur Seite. Die Siebdrucke wurden von Hundertwassers langj&auml;hrigem Drucker in Venedig, Claudio Barbato, gefertigt. Das Objekt wurde in einer Auflage von 999 Exemplaren hergestellt.</p>
	</div>
	</div>
...
<div id="containerRight">
	...
	<ul>
    	<li class="active"><a href="deutsch/werk/ankunst/apa_fallincloud.php">Fall in Cloud</a></li>
    	...
    	<li><a href="deutsch/werk/ankunst/apa_keramikporzellan.php.htm">Keramik &amp; Porzellan</a></li>
    </ul>
</div>
