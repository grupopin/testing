...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>913C AUGEN DER STADT - DAS FENSTERRECHT</h1><br/>Dreidimensionales Objekt, 1992";

	var picpath = new Array();
	picpath[0]= "deutsch/werk/ankunst/images/hundertwasser/apa/apa_0289.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content">
	  ...
	  <h2>AUGEN DER STADT <br/>DAS FENSTERRECHT</h2>
 	...
 	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/apa/apa_0289_sml.jpg" width="195" height="260" alt=""></a></p>
      ...
      <p class="werk">Dreidimensionales Objekt, 1992</p>
        <p>Diesem Objekt aus Holz, Glas, Acryl, Karton, Stucco und Keramik, mit Aquarellfarben bemalt, liegt die architektonische Gestaltung des KunstHausWien zugrunde. Es wurde nach Hundertwassers Entwurf von seinen Modellbauern Alfred Schmid, Klosterneuburg, und Andreas Bodi, Maria Enzersdorf, in einer Auflage von 500 St&uuml;ck hergestellt. </p>

		<p> Es zeigt eine Hausfassade, nicht perfekt glatt und flach, sondern buckelig und mit unregelm&auml;&szlig;igen Mosaiken durchzogen. Das unregelm&auml;&szlig;ige Schachbrettmuster signalisiert das Aufbrechen des Rastersystems. Fenster sind f&uuml;r Hundertwasser die Br&uuml;cke zwischen innen und au&shy;&szlig;en, ein &Auml;quivalent zu den Augen.</p>
  </div>
...
<div id="containerRight">
	...
	<ul>
    	...
    	<li class="active"><a href="deutsch/werk/ankunst/apa_augenderstadt.php">Augen der Stadt</a></li>
