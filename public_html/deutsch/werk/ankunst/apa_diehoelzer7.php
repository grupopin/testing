...
<script language="JavaScript" type="text/JavaScript">
	...
	picpath[0]= "deutsch/werk/ankunst/images/hundertwasser/apa/apa_hoelzer7.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content" class="wide">
	...
	<p class="werk">Kunstobjekt und kreatives Spiel, 1992-2004</p>
	<p style="height: 10px;"></p>
	<p style="font-style: italic;">"DieHoelzerSiebeN sind ein Architekturspiel f&uuml;r Erwachsene, die noch tr&auml;umen k&ouml;nnen und noch tr&auml;umen wollen, und f&uuml;r Kinder, denen die Kreativit&auml;t noch nicht weggenommen wurde."<br/>
	<span class="reference">Hundertwasser, November 1999</span></p>

	<p style="height: 10px;"></p>
	<p>Von 1992 bis kurz vor seinem Tod besch&auml;ftigte sich Hundertwasser immer wieder intensiv mit seiner Idee eines kreativen Kunst- und Architekturspieles. Es vergingen weitere Jahre, bis das geeignete Holz aus nachhaltigem Anbau gefunden und die H&ouml;lzer in einem aufwendigen Siebdruckverfahren bedruckt werden konnten. Beim Druck wurden 130 Durchg&auml;nge in sieben Farben ausgef&uuml;hrt. Jedes Holz mu&szlig;te dabei mehrmals in die Hand genommen werden, dadurch wurde jedes Exemplar zu einem besonderen Unikat. </p>


	<p>DieHoelzerSiebeN wurden in limitierter Erstedition von 2000 Exemplaren hergestellt.<br/>
	Dieses Kunst- und Architekturspiel bietet unz&auml;hlige M&ouml;glichkeiten, beseelte Bauk&ouml;rper zusammenzustellen zu einer "Architektur f&uuml;r dich und mich". </p>
...
<div id="containerRight">
	...
	<ul>
    	...
    	<li class="active"><a href="deutsch/werk/ankunst/apa_diehoelzer7.php">DieHoelzerSiebeN</a></li>
    	<li><a href="deutsch/werk/ankunst/apa_buecher.php">Buchgestaltungen</a></li>
    	<li><a href="deutsch/werk/ankunst/apa_keramikporzellan.php">Keramik &amp; Porzellan</a></li>
    </ul>
</div> <!-- /containerRight -->
