...
<head>
<title>St. Barbara Kirche, B&auml;rnbach &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>St. Barbara Kirche</h1>B&auml;rnbach, 1987-1988<br/>Foto: Herbert Schwingenschl&ouml;gl"; //ARCH 50 	
	picdesc[1]= "<h1>St. Barbara Kirche</h1>Einer von zw&ouml;lf Torb&ouml;gen f&uuml;r den Prozessionsweg bei der St. Barbara Kirche, B&auml;rnbach<br/>B&auml;rnbach, 1987-1988<br/>Foto: Wolfgang Seidel";
	picdesc[2]= "<h1>St. Barbara Kirche</h1>Christus mit der Aureole<br/>B&auml;rnbach, 1987-1988<br/>Foto: Herbert Kluger";

	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/st_barbara/arch_0050_31_SC.jpg";
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/st_barbara/ARCH_0050_7.jpg"
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/st_barbara/arch_0050_XI_1.jpg";	
...
<div id="contentwrapper">
	...
	<div class="newsItem">
  		<h2>St. Barbara Kirche, B&auml;rnbach</h2>
	    <h3>1987-1988</h3>
	    <p><i>8572 B&auml;rnbach, &Ouml;sterreich</i></p>
		
		<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/st_barbara/arch_0050_31_SC_sml.jpg" width="255" height="228" alt="" /></a></p>
        <p>Auf Initiative von Pfarrer Friedrich Zeck hat Hundertwasser die Neugestaltung
        der St. Barbara Kirche in B&auml;rnbach &uuml;bernommen. Seiner Bedingung, die
        Umgebung der Kirche in die Planung miteinzubeziehen, wurde aufgrund der Bem&uuml;hungen
        von B&uuml;rgermeister Konrad Bergmann seitens der Gemeinde entsprochen.
        </p>
        <div style="height: 20px;"></div>
        
        <p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/st_barbara/ARCH_0050_7_sml.jpg" width="140" height="100" alt="" class="inlineimg" /></a>
        Mit der Gestaltung von 12 Toren, die f&uuml;r alle gro&szlig;en Weltreligionen stehen, setzt Hundertwasser
        eine Geste der &Ouml;kumene, der Toleranz und der Gemeinsamkeit.
        </p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/st_barbara/arch_0050_XI_1_sml.jpg" width="165" height="255" alt="" /></a></p>

	    <p>Hundertwasser hat mit seiner Kirchengestaltung in gro&szlig;artiger Zusammenarbeit
        mit Architekt Manfred Fuchsbichler ein bemerkenswertes Wahrzeichen in einem
        Industriegebiet geschaffen. Mit dem Entwurf des Innenraums wurden einheimische
        K&uuml;nstler beauftragt, Hundertwasser gestaltete nur den Strahlenkranz hinter
        dem Altar, den Boden des Presbyteriums und die Spirale des Fensters hinter dem
        Taufbecken.</p>
               
        <p>Bei der Beschaffung der finanziellen Mittel hat Hundertwasser die Pfarrgemeinde
        tatkr&auml;ftig unterst&uuml;tzt.</p>
   		
<!-- START::Mediaplayer -->
<div class="newsItem">
<a href="javascript:void(0);" onclick="window.open('/mediaplayer/?file=D-Eine Kirche soll schoen sein', 'mediaplayer', 'width=640,height=480,status=no,scrollbars=no,resizable=no');" style="cursor: pointer;">
<table border="0">
 <tr><td align="center"><img src="mediaplayer/covert5-0.gif" alt="" /></td></tr>
 <tr><td style="font-size: 11px;">Eine Kirche soll sch&ouml;n sein</td></tr>
</table>
</a>
</div>
<!-- END::Mediaplayer -->
