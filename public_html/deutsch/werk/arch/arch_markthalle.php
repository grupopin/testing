...
<head>
<title>Markthalle Altenrhein &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Markthalle Altenrhein, 1998-2001</h1>Foto: Herbert Lindemann";	
	picdesc[1]= "<h1>Markthalle Altenrhein, 1998-2001</h1>Foto: Herbert Lindemann";	
	picdesc[2]= "<h1>Markthalle Altenrhein, 1998-2001</h1>Foto: Herbert Lindemann";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/markthalle/arch_0123_lindem.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/markthalle/arch123_markthalle_04.jpg";		
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/markthalle/arch123_markthalle_01.jpg";		
...
<div id="contentwrapper">
	...
	<div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Markthalle Altenrhein </h2>
		<h3>1998-2001</h3>
        <p><i>Knotternstrasse 2, 9422 Staad am Bodensee, Schweiz</i></p>
        <p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/markthalle/arch123_markthalle_04_sml2.jpg" alt="Markthalle" width="53" height="100" class="inlineimg" style="margin-top:3px;"/></a>
        Das Geb&auml;ude wurde urspr&uuml;nglich als Markthalle entworfen, in der Naturprodukte
        aus der Region angeboten werden sollten. Mittlerweile wird es jedoch f&uuml;r kulturelle
        Veranstaltungen genutzt.</p>
         
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/markthalle/markthalle2-thumb.jpg" alt="Markthalle" width="75" height="100" class="inlineimg-alt" style="margin-top:3px;"/></a>
        Die Flaschen-Wand wurde in Anlehnung an das von Hundertwasser gestaltete "Bottlehouse"
        auf seinem Anwesen in Neuseeland ausgef&uuml;hrt. Bei der Fassadengestaltung wurde eine
        Riffelung des Verputzes durchgef&uuml;hrt.</p>
  </div>
