...
<head>
<title>Quixote Weinkellerei &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Quixote Weinkellerei, Napa Valley, 1992-1999</h1>Foto: Quixote Winery";	
	picdesc[1]= "<h1>Quixote Weinkellerei, Napa Valley, 1992-1999</h1>Foto: Quixote Winery";

		
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/quixote_winery/quixote_winery_01_big.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/quixote_winery/quixote_winery_02_big.jpg";
...
<div id="contentwrapper">
	...
	<div style="padding: 40px 0 0 50px; width: 400px;">
  		<h2>Quixote Weinkellerei</h2>
		<h3>1992-1999</h3>
        <p><i>6126 Silverado Trail, Napa Valley, CA 94558, California, USA</i></p>
        <p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/quixote_winery/quixote_winery_02_sml.jpg" alt="Winery" class="inlineimg" style="margin-top:4px;"/></a> Das Geb&auml;ude ist vollkommen von Natur bedeckt, so da&szlig; man auf allen Teilen des Daches herumwandern kann. Eine Mehrung von Natur als Antwort auf die Zerst&ouml;rungen der St&auml;dte. </p>
