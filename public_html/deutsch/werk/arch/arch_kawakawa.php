...
<head>
<title>&Ouml;ffentliche Toilette Kawakawa &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Hundertwasser mit dem Modell der Kawakawa Toilet, Neuseeland, 1999</h1>Foto: Richard Smart";	
	picdesc[1]= "<h1>Öffentliche Toilette Kawakawa, 1999</h1>Foto: Malcolm Pullmann";		
	picdesc[2]= "<h1>Hundertwasser mit dem Modell der Kawakawa Toilet, Neuseeland, 1999</h1>Foto: Richard Smart";		
	picdesc[3]= "<h1>Hundertwasser mit dem Modell der Kawakawa Toilet, Neuseeland, 1999</h1>Foto: Richard Smart";		


	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/toilette_kawakawa/arch119_toilkawakawa_11.jpg";	
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/toilette_kawakawa/arch_0119.jpg";
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/toilette_kawakawa/toilette1.jpg";	
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/toilette_kawakawa/toilette2.jpg";	
...
<div id="contentwrapper">
	...
	<div style="padding: 40px 0 0 35px; width: 400px;">
  		<h2>&Ouml;ffentliche Toilette Kawakawa</h2>
  		<h3>1999</h3>
  		<p><i>Kawakawa, Neuseeland</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/toilette_kawakawa/toilette1-thumb.jpg" alt="Toilette" width="100" height="124" class="inlineimg"/style="margin-top:3px;"></a>Der Verein der &ouml;rtlichen Kaufmannschaft wandte sich an Hundertwasser mit der Bitte, die Umgestaltung des aus den sechziger Jahren stammenden Geb&auml;udes zu &uuml;bernehmen, nicht zuletzt, um Kawakawa ein kleines Zeichen seiner Kunst zu schenken. W&auml;hrend des Umbaus stellte sich heraus, da&szlig; die notwendigen Sanierungsma&szlig;nahmen umfangreicher als vorgesehen waren.</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/toilette_kawakawa/toilette2-thumb.jpg" alt="Toilette" width="100" height="100" class="inlineimg" style="margin-top:3px;"/> Hundertwasser legte bei der Umgestaltung selbst Hand an, unter anderem gestaltete er die S&auml;ulen eigenh&auml;ndig und setzte sie mit Keramik aus Asien zusammen. Eine Flaschenwand lie&szlig; er in Anlehnung an das "Bottlehouse" auf seinem Anwesen gestalten. Auch f&uuml;r die Bewaldung des Daches sorgte er selbst. F&uuml;r die Front des Geb&auml;udes suchte er eine Platane aus und f&uuml;r die R&uuml;ckseite einen Tulpenbaum. In die Gestaltung eingebunden waren K&uuml;nstler der Maori und der K&uuml;nstler Peter Yeates. </a></p>
  </div>
