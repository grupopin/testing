...
<head>
<title>Geschichte &middot; KunstHausWien</title>
...
<script type="text/javascript">
	...
	picdesc[0]= "Hofansicht der ehemaligen Thonet-Fabrik vor der Umgestaltung durch Hundertwasser<br>Foto: Hundertwasser Archiv";	
	picdesc[1]= "Foto: Herbert Schwingenschl&ouml;gl";	
	picdesc[2]= "";	

	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/khw/arch_0068_khw_vorzustand_big.jpg";	
	picpath[1]= "deutsch/werk/arch/images/khw/arch_0068_8_sc_big.jpg";	
	picpath[2]= "deutsch/werk/arch/images/khw/default.htm";	
...
<link rel="start" title="Home" href="default.htm"/>
...
<div id="contentwrapper">
 <!-- totop wrapped -->
  ...
  <div id="content">
  	<h2>KunstHausWien</h2>
        <h3>1989-1991</h3>
  	    <p><i>Untere Wei&szlig;gerberstra&szlig;e 13, 1030 Wien, &Ouml;sterreich</i>
  	    <br><i>Tel. 712 04 95</i>
  	    <br><a href="http://www.kunsthauswien.com/" target="_blank">www.kunsthauswien.com</a>
  	    </p>

	<div class="newsItem">
	<p>
	<a href="javascript:showPic(1)"><img src="images/khw/arch_0068_8_sc_sml.jpg" width="164" height="171" alt="" /></a>
  <a href="javascript:showPic(0)"><img src="images/khw/arch_0068_khw_vorzustand_sml.jpg" width="120" height="170" alt="" /></a>
  </p>
	<p>Als geeignete R&auml;umlichkeiten f&uuml;r eine st&auml;ndige Ausstellung von Hundertwassers malerischem
	Werk konnten im dritten Wiener Gemeindebezirk die Geb&auml;ude der ehemaligen M&ouml;belfabrik der
	Gebr&uuml;der Thonet aus dem Jahr 1892 gefunden werden.</p>
	</div>
	<div class="newsItem alternative">	
	<p><img src="images/khw/baustelle_small.jpg" width="144" height="190" alt="" /></p>
	<p>Die Gr&ouml;&szlig;e der Geb&auml;ude bot die M&ouml;glichkeit,
	nicht nur ein Hundertwasser-Museum einzurichten, sondern dar&uuml;ber hinaus eine Nutzung f&uuml;r
	internationale Wechselausstellungen miteinzuplanen. Der Umbau, bei dem zwei H&auml;user zusammengelegt
	wurden, wurde in den Jahren 1989 bis 1991 unter der Bauherrschaft der Bank f&uuml;r Arbeit und
	Wirtschaft und ihrem Generaldirektor Walter Fl&ouml;ttl durchgef&uuml;hrt.</p>
	</div>
	
	<div class="newsItem"> 
	<p><img src="images/khw/baustelle2_small.jpg" width="162" height="210" alt="" /></p>
	<p>Hundertwasser griff in die alte Bausubstanz sehr behutsam ein. Zur Stra&szlig;e hin wurde ein Vorbau
	angef&uuml;gt, dessen Glasfront die Ausstellungsr&auml;ume zus&auml;tzlich mit Licht versorgt, hofseitig ein
	Treppenhaus. Am 9. April fand die Er&ouml;ffnung des KunstHausWien statt, das privatwirtschaftlich
	und nicht mit &ouml;ffentlichen Subventionen oder mit Steuergeldern gef&uuml;hrt wird.</p>
	<p>Die gesamte Ausstellungsfl&auml;che betr&auml;gt rund 4000 m<sup>2</sup>. Im Erdgescho&szlig; sind neben Kasse und Garderobe auch ein Museumshop und ein Caf&eacute;-Restaurant untergebracht. In den beiden ersten Stockwerken wird ein Querschnitt durch Hundertwassers Oeuvre	geboten, das Malerei, Graphik, Tapisserien und Architekturmodelle umfa&szlig;t. Der dritte und vierte Stock sind internationalen Wechselausstellungen vorbehalten.</p>
	</div>
	

<!-- START::Mediaplayer -->
<div class="newsItem">
<a href="javascript:void(0);" onclick="window.open('/mediaplayer/?file=D-Das KHW', 'mediaplayer', 'width=640,height=480,status=no,scrollbars=no,resizable=no');" style="cursor: pointer;">
<table border="0">
 <tr><td align="center"><img src="mediaplayer/covert5-0.gif" alt="" /></td></tr>
 <tr><td style="font-size: 11px;">Das KunstHausWien</td></tr>
</table>
</a>
</div>
<!-- END::Mediaplayer -->
