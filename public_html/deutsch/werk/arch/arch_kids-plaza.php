...
<head>
<title>Kids Plaza Osaka &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Kids Plaza Osaka</h1>KINDERABENTEUERARCHITEKTUR, 1996/97<br/>Foto: HU-NET Corporation, Osaka";	
	picdesc[1]= "<h1>Kids Plaza Osaka</h1>KINDERABENTEUERARCHITEKTUR, 1996/97<br/>Foto: HU-NET Corporation, Osaka";	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/kidsplaza_osaka/arch102_kidsplazaosaka.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/kidsplaza_osaka/arch089_kidsplazaosaka.jpg";	
...
<div id="contentwrapper">
	...
	<div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Kids Plaza Osaka <br/>KINDERABENTEUERARCHITEKTUR</h2>
  		<h3>1996/97</h3>
        <p><i>2-1-7 Ogimachi, Kita-ku, Osaka 530, Japan</i></p>

		<p>Kids Plaza Osaka ist ein Museum f&uuml;r Kinder, das sich zum Ziel setzt, Kindern zur freien Entfaltung ihrer Kreativit&auml;t zu verhelfen. Eine Vielfalt von Ausstellungen, Veranstaltungen und Workshops l&auml;sst die Kinder spielerisch ihre Welt entdecken.</p>

		<p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/kidsplaza_osaka/kidsplaza-thumb.jpg" alt="kidsplaza-thumb" width="120" height="103" class="inlineimg" style="margin-top:4px;"/></a> Hundertwasser &uuml;bernahm die Gestaltung der Kids Town, die sich im Atrium zwischen dem 4 und 5 Stock befindet und in deren Zentrum ein gewendelter Turm steht. Er schuf einen Gegenpol zur sterilen, computergeregelten, natur- und menschenfeindlichen Architektur, in der die Kinder den Gro&szlig;teil ihrer Zeit verbringen - eine Architektur, die ein Abenteuer f&uuml;r die Fantasie und die Sinne ist, eine Wiedergutmachung an der Seele der Menschen. </p>
  </div>
