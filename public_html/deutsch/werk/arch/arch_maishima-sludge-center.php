...
<head>
<title>Maishima Sludge Center &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Maishima Sludge Center, 2000-2004</h1>Fotos: Naoomi Kurozumi";	
	picdesc[1]= "<h1>Maishima Sludge Center, 2000-2004</h1>Fotos: Naoomi Kurozumi";	
	picdesc[2]= "<h1>Maishima Sludge Center, 2000-2004</h1>Fotos: Naoomi Kurozumi";	
	picdesc[3]= "<h1>Maishima Sludge Center, 2000-2004</h1>Fotos: Naoomi Kurozumi";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter_031.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter_087.jpg";		
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter_037.jpg";		
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter_049.jpg";		
...
<div id="contentwrapper">
	...
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter_031_sml.jpg" width="191" height="255" alt=""></a><br/>
	  ...
	  <div style="padding: 40px 0 0 40px; width: 370px;">
        ...
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter1-thumb.jpg" alt="Sludge Center" width="100" height="75" class="inlineimg" style="margin-top:3px;"/></a> Im Auftrag der Stadt Osaka &uuml;bernahm Hundertwasser die architektonische Gestaltung dieser Schlammverwertungsanlage. Es handelt sich um eine Anlage zum Recycling von Kl&auml;rschlamm zur Produktion von Ziegeln, Fliesen und Bodenplatten. Diese ungef&auml;hr 170 Meter lange, 110 Meter breite und 40 Meter hohe Industrieanlage mit dem fast 140 Meter hohen Kamin-Turm befindet sich in der N&auml;he der von Hundertwasser architektonisch gestalteten MOP M&uuml;llverbrennungsanlage.</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/maishima_sludgecenter/sludgecenter2-thumb.jpg" alt="Sludge Center" width="48" height="120" class="inlineimg-alt" style="margin-top:3px;"/></a> Hundertwasser konzipierte das unterste Drittel, ca. 30 Meter des Schlots, als eine bewaldete Spirale, die sich organisch, in unregelm&auml;&szlig;igen Abst&auml;nden emporwindet. Dazu konzipierte er ein spezielles Bew&auml;sserungs- bzw. Wasserregulierungssystem. </p>
  </div>
