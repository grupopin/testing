...
<head>
<title>Die Wald-Spirale von Darmstadt &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Die Wald-Spirale von Darmstadt, 1998-2000</h1><br/>Foto: Peter Mosdzen";	
	picdesc[1]= "<h1>Die Wald-Spirale von Darmstadt, 1998-2000</h1><br/>Foto: Peter Mosdzen";	
	picdesc[2]= "<h1>Die Wald-Spirale von Darmstadt, Architekturmodell, 1996</h1><br/>Foto: Hundertwasser Archiv";	
	picdesc[3]= "<h1>Die Wald-Spirale von Darmstadt, 1998-2000</h1><br/>Foto: Christa Kreuter";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_09.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_13.jpg";		
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_01.jpg";		
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_02.jpg";		
...
<div id="contentwrapper">
	...
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/wald_spirale/arch_waldspirale_09_sml.jpg" width="230" height="164" alt=""></a><br/>
	<br/>
  <a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/wald_spirale/arch_waldspirale_13_sml.jpg" width="230" height="155" vspace="15" alt=""></a></div>
  <div style="padding: 40px 0 0 40px; width: 420px;">
  		<h2>Die Wald-Spirale von Darmstadt</h2>
		<h3>1998-2000</h3>
        <p><i>B&uuml;rgerparkviertel; Friedberger Stra&szlig;e / Bad Nauheimer Stra&szlig;e, 64293 Darmstadt, Deutschland</i><p>
		<p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/wald_spirale/waldspirale1-thumb.jpg" alt="Waldspirale" width="42" height="120" class="inlineimg" style="margin-top:3px;"/></a> Der Bauverein Darmstadt beauftragte Hundertwasser, ein Bauwerk mit 105 Wohneinheiten
    im Bereich des B&uuml;rgerparkviertels zu entwerfen. Hundertwasser hatte die Idee, das Grundst&uuml;ck
    in einer ansteigenden, bewaldeten Spiral-Form zu bebauen. </p>
    
    <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/wald_spirale/waldspirale2-thumb.jpg" alt="Waldspirale" width="63" height="100" class="inlineimg-alt" style="margin-top:2px;"/></a> Der Bauk&ouml;rper entwickelt sich von der S&uuml;d-West-Ecke &uuml;ber eine st&auml;ndig ansteigende begr&uuml;nte Schr&auml;ge bis auf neun Gescho&szlig;e
    an der S&uuml;d-Ost-Ecke des Grundst&uuml;cks, die durch einen 41 Meter hohen Turm, der sich &uuml;ber zw&ouml;lf
    Gescho&szlig;e erstreckt, einen besonderen Akzent erh&auml;lt. Die Fassaden gestaltete Hundertwasser als
    ein Gleichnis zu den Schichtenlinien der Erde, zu den Sedimenten, sie sich seit Jahrmillionen
    gebildet haben. </p>
  </div>
