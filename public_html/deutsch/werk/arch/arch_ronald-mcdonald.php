...
<head>
<title>Ronald McDonald Haus &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Ronald McDonald Haus, 2004-2005</h1><br/>Foto: Peter Mosdzen";	
	picdesc[1]= "<h1>Ronald McDonald Haus, 2004-2005</h1><br/>Foto: Peter Mosdzen";	
	picdesc[2]= "<h1>Ronald McDonald Haus, 2004-2005</h1><br/>Foto: Peter Mosdzen";	
	picdesc[3]= "<h1>Ronald McDonald Haus, 2004-2005</h1><br/>Foto: Alexander Proefrock";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/ronald_mcdonald/donald_03.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/ronald_mcdonald/donald_04.jpg";			
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-1.jpg";			
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-2.jpg";			
...
<div id="contentwrapper">
  ...
  <div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Ronald McDonald Haus Essen</h2>
		  <h3>2004-2005</h3>
        <p><i>Unterm Sternenzelt 1, 45147 Essen, Deutschland</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-1.png" alt="" width="69" height="100" class="inlineimg"/style="margin-top:4px;"></a> Im August 1999 schuf Hundertwasser erste Skizzen f&uuml;r dieses Familienzentrum f&uuml;r Angeh&ouml;rige schwer kranker Kinder am Universit&auml;tsklinikum Essen. Es ist eines von 14 Ronald McDonald H&auml;usern in Deutschland, die sich in der N&auml;he von Kinderkliniken befinden und in denen Familienangeh&ouml;rige w&auml;hrend der oft langwierigen Behandlungsdauer der Kinder ein Zuhause auf Zeit finden.</p> 
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-2.png" alt="" width="87" height="100" class="inlineimg"/></a> Hundertwasser nahm den Auftrag an, weil es neben der sozialen, menschlichen Komponente auch darum ging zu demonstrieren, da&szlig; trotz Hausbau die Natur nicht zerst&ouml;rt wird, sondern nach dem Bau mehr Natur vorhanden ist als es vorher gab. Nur unter dieser Voraussetzung durfte dort,&nbsp;in einem Naturschutzgebiet, einem der ber&uuml;hmtesten Parks Deutschlands, dem Gruga-Park, &uuml;berhaupt gebaut werden.&nbsp;Es wurde Hundertwassers&nbsp;Credo entsprechend ein Haus in Harmonie mit der Natur und der individuellen Kreativit&auml;t des Menschen umgesetzt. </p>
  </div>
