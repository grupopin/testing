...
<head>
<title>Martin-Luther-Gymnasium in Wittenberg &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Martin-Luther-Gymnasium in Wittenberg, 1997-1999</h1>Foto: Miguel Raurich";	
	picdesc[1]= "<h1>Martin-Luther-Gymnasium in Wittenberg, 1997-1999</h1>Foto: Miguel Raurich";	
	picdesc[2]= "<h1>Martin-Luther-Gymnasium in Wittenberg, 1997-1999</h1>Foto: Miguel Raurich";	
	picdesc[3]= "<h1>Martin-Luther-Gymnasium in Wittenberg, Architekturmodell, 1997</h1>Foto: Hundertwasser Archiv";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/martin_luther_gym/arch114_ml_gym_02.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/martin_luther_gym/arch114_ml_gym_04.jpg";			
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/martin_luther_gym/gymnasium1.jpg";		
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/martin_luther_gym/gymnasium2.jpg";		
...
<div id="contentwrapper">
	...
	<h3>1997-1999</h3>
        <p><i>Stra&szlig;e der V&ouml;lkerfreundschaft 130<br/>
        06886 Wittenberg, Deutschland</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/martin_luther_gym/gymnasium1-thumb.jpg" alt="Gymnasium" width="86" height="100" class="inlineimg" style="margin-top:3px;"/></a>
        Anl&auml;&szlig;lich der notwendigen Gesamtsanierung des Betonplattenbaus aus den siebziger Jahren &auml;u&szlig;erten die Sch&uuml;ler und Lehrer des Gymnasiums den Wunsch, Hundertwasser solle die Umgestaltung der Schule &uuml;bernehmen. Hundertwasser entwickelte ehrenamtlich das Konzept und die Gestaltung, die Planung wurde von Architekt Peter Pelikan &uuml;bernommen.</p>

        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/martin_luther_gym/gymnasium2-thumb.jpg" alt="Gymnasium" width="57" height="120"class="inlineimg" style="margin-top:3px;"/></a> Die Schule soll im Meer von sogenannten rationellen H&auml;usern eine Oase f&uuml;r die Menschlichkeit und f&uuml;r die Natur sein, sie soll die Kreativit&auml;t der Kinder f&ouml;rdern und die Sehns&uuml;chte der Menschen nach Romantik verwirklichen.</p>
  </div>
