...
<head>
<title>&ldquo;Mop&rdquo; Maishima M&uuml;llverbrennungsanlage &middot; Projekte &middot; Architektur &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Mop Maishima M&uuml;llverbrennungsanlage, 1997-2001</h1>Foto: HU-NET Corporation, Osaka";	
	picdesc[1]= "<h1>Mop Maishima M&uuml;llverbrennungsanlage, 1997-2001</h1>Foto: HU-NET Corporation, Osaka";	
	picdesc[2]= "<h1>Mop Maishima M&uuml;llverbrennungsanlage, 1997-2001</h1>Foto: HU-NET Corporation, Osaka";	
	picdesc[3]= "<h1>Mop Maishima M&uuml;llverbrennungsanlage, 1997-2001</h1>Foto: HU-NET Corporation, Osaka";	
	
	var picpath = new Array();
	picpath[0]= "deutsch/werk/arch/images/hundertwasser/architektur/muell_maishima/muell_maishima30.jpg";		
	picpath[1]= "deutsch/werk/arch/images/hundertwasser/architektur/muell_maishima/muell_maishima33.jpg"
	picpath[2]= "deutsch/werk/arch/images/hundertwasser/architektur/muell_maishima/MOP-1.jpg"
	picpath[3]= "deutsch/werk/arch/images/hundertwasser/architektur/muell_maishima/MOP-3.jpg"
...
<div id="contentwrapper">
  ...
  <div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>"Mop" Maishima M&uuml;llverbrennungsanlage</h2>
		<h3>1997-2001</h3>
        <p><i>2-1-1, Hokkoushiratsu, Konohana-kud, Osaka, Japan</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/muell_maishima/MOP-1.png" alt="" width="100" height="96" class="inlineimg"/></a> Die &ouml;kologische M&uuml;llverbrennungsanlage f&uuml;r die Stadt Osaka wurde im Rahmen des Maishima Island Project vom japanischen Architektenteam Showa Sekkei geplant. Hundertwasser wurde beauftragt, den gesamten Komplex mit Kaminturm (120 Meter) architektonisch um- und neuzugestalten.</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/muell_maishima/MOP-3.png" alt="" width="100" height="67" class="inlineimg"/></a> 
        Die M&uuml;llverbrennungsanlage ist mit den modernsten Filteranlagen ausger&uuml;stet. Drei Stockwerke sind als Erlebniswelt mit didaktischer Funktion gestaltet, um den Besuchern, vor allem Schulklassen, die Abfallprobleme bewu&szlig;t zu machen und ihre Mitarbeit an einer m&uuml;llfreien Gesellschaft zu f&ouml;rdern.</p>
  </div>
