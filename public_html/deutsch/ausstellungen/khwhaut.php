...
<html xmlns="http://www.w3.org/1999/xhtml" id="black">
<head>
<title>Die dritte Haut im dritten Bezirk &middot; Hundertwasser &uuml;ber das KunstHausWien &middot; KunstHausWien</title>
...
<script type="text/javascript">
	...
	picdesc[0]= "<h2>KUNSTHAUSWIEN, 1989-1991</h2>Foto: Herbert Schwingenschl&ouml;gl";	
	picdesc[1]= "<h2>KUNSTHAUSWIEN, 1989-1991</h2>Foto: Herbert Schwingenschl&ouml;gl";	

	var picpath = new Array();
	picpath[0]= "deutsch/ausstellungen/images/khw/arch_0068_16_sc_big.jpg";	
	picpath[1]= "deutsch/ausstellungen/images/khw/arch_0068_6_big.jpg";	
...
<div id="contentwrapper">
	...
	<div id="content">
	<h2>Die dritte Haut im dritten Bezirk</h2>

	<div class="newsItem">
	<p><a href="javascript:showPic(0)"><img src="images/khw/arch_0068_6_sml.jpg" alt=""></a></p>
	<p>
	Von der dritten Haut, der Au&szlig;enhaut des KunstHausWien, ist hier die Rede.
	</p>
	<p>
	Der Mensch ist von drei Schichten umgeben, von der Haut, von der Kleidung und von den Mauern, dem Geb&auml;ude. Kleidung und Geb&auml;udemauern haben in der letzten Zeit eine Entwicklung genommen, die nicht mehr den Naturbed&uuml;rfnissen des einzelnen entsprechen.
	</p>
	<p>
	Fenster sind die Br&uuml;cke zwischen dem Innen und Au&szlig;en. Die dritte Haut ist von Fenstern durchl&ouml;chert wie die erste Haut von Poren.
	</p>
	<p>
	Die Fenster sind ein &Auml;quivalent zu den Augen. (...)
	</p>
	</div>
	
	<div class="newsItem alternative">
	<p>
	<a href="javascript:showPic(1)"><img src="images/khw/hw_im_khw_2.jpg" alt="image" width="73" height="103" /></a> Die Fassade ist nicht perfekt glatt und flach, sondern bucklig und mit unregelm&auml;&szlig;igen Mosaiken durchzogen. Schwarzwei&szlig;es, unregelm&auml;&szlig;iges Schachbrettmuster signalisiert das Aufl&ouml;sen des Rastersystems.
	</p>
	<p>
	Was wir dringend ben&ouml;tigen sind Sch&ouml;nheitshindernisse, diese Sch&ouml;nheitshindernisse bestehen aus unreglementierten Unregelm&auml;&szlig;igkeiten.
	</p>
	<p>
	Paradiese kann man nur selber machen, mit eigener Kreativit&auml;t in Harmonie mit der freien Kreativit&auml;t der Natur.
	</p>
	<p>
