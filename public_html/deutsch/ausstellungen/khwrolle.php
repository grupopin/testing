...
<head>
<title>Rolle &middot; Hundertwasser &uuml;ber das KunstHausWien &middot; KunstHausWien</title>
...
<script type="text/javascript">
	...
	picdesc[0]= "Foto: Peter Strobl";	
	picdesc[1]= "";	

	var picpath = new Array();
	picpath[0]= "deutsch/ausstellungen/images/khw/kunsthaus3.jpg";	
	picpath[1]= "deutsch/ausstellungen/images/khw/apa_0006_1_big.jpg";		
...
<div id="contentwrapper">
	...
	<div id="content">
	<h2>Zur Rolle des KunstHausWien</h2>
		<div class="newsItem alternative">
		<p><a href="javascript:showPic(0)"><img src="images/khw/khw_rolle_1.jpg" alt=""></a></p>
		<p>
		Die Architektur des KunstHausWien ist das erste Bollwerk gegen eine falsche
		Ordnung der geraden Linie, der erste Br&uuml;ckenkopf gegen das Rastersystem
		und gegen das Chaos des Nonsens.
		</p>
		<p>
		Die Kunst mu&szlig; wieder die Natur und ihre Gesetze und den
		Menschen und sein Streben
		nach wahren und dauerhaften Werten einbeziehen.
		Die Kunst mu&szlig; wieder Br&uuml;cke zwischen der Sch&ouml;pfung,
		der Natur und der Kreativit&auml;t des Menschen sein.
		Die Kunst mu&szlig; wieder eine Gesammtheitsfunktion erlangen
		und nicht nur f&uuml;r eine Insidergruppe gemacht werden.
		</p>
		<p>
		<span><a href="javascript:showPic(1)"><img src="interface/white/gr4.png" alt="image" width="78" height="106" /></a></span> Kunst mu&szlig; sich befreien
		von den Fesseln der gelenkten Kulturpolitik,
		befreien von den Fesseln der Spekulation
		und der Kunstindustrie,
		befreien von den Fesseln der zerst&ouml;rerischen Theorien.
		</p>
		<p>
		Kunst mu&szlig; wieder einen Sinn bekommen.
		Kunst mu&szlig; wieder bleibende Werte schaffen.
		Mut zur Sch&ouml;nheit in Harmonie mit der Natur.
		Das KunstHausWien hat sich diese hohe Aufgabe gestellt.
		</p>
		<p>
		<em>Hundertwasser, Oktober 1990</em>
		</p></div>
...
<div id="containerRight">
	...
	<ul>
<li><a href="deutsch/ausstellungen/hw_im_khw.php">Hundertwasser im KunstHausWien</a><ul><li class="active"><a href="deutsch/ausstellungen/khwrolle.php">Zur Rolle des KunstHausWien</a></li><li><a href="deutsch/ausstellungen/khwhaut.php">Die dritte Haut im dritten Bezirk</a></li><li><a href="deutsch/ausstellungen/khwboden.php.htm">Der unebene Boden</a></li><li><a href="deutsch/ausstellungen/hundertwasser-ausstellung.php.htm">Aus der Hundertwasser Ausstellung im KunstHausWien</a></li></ul></li><li><a href="deutsch/ausstellungen/ausstellungsprogramm.php">Ausstellungsprogramm</a></li><li><a href="deutsch/ausstellungen/Wcd47b505e67a0.htm">Ausstellungen Archiv</a></li> 
	</ul>
</div> <!-- /containerRight -->
</div> <!-- /wrapper -->
