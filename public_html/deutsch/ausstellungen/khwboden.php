...
<head>
<title>Der unebene Boden &middot; Hundertwasser &uuml;ber das KunstHausWien &middot; KunstHausWien</title>
...
<script type="text/javascript">
	...
	picdesc[0]= "KUNSTHAUSWIEN, 1989-1991, Foto: Herbert Schwingenschl&ouml;gl";	
	picdesc[1]= "KUNSTHAUSWIEN, 1989-1991, Foto: Helmut Klein";	
	picdesc[2]= "Hundertwassers selbst gemachte Sommer- und Winterschuhe, Paris, 1950<br>Foto: Hundertwasser Archiv";	

	var picpath = new Array();
	picpath[0]= "deutsch/ausstellungen/images/khw/arch_0068_13_sc_big.jpg";	
	picpath[1]= "deutsch/ausstellungen/images/khw/arch_0068_12_kl_big.jpg";	
	picpath[2]= "deutsch/ausstellungen/images/khw/1950_schuhe_big.jpg";	
...
<body onLoad="MM_preloadImages('images/khw/khw_buildings_6.jpg')" id="ausstellungen">

<h1 id="siteTitle"><a href="default.htm" rel="home" title="KunstHausWien Home">KunstHausWien</a></h1>
...
<div id="contentwrapper">
	...
	<div id="content">
  		<h2>Der unebene Boden</h2>

		<div class="newsItem">
		<p><a href="javascript:showPic(0)"><img src="images/khw/khw_wellboden_1.jpg" alt=""></a></p>
		<p>
		Der gerade Boden ist eine Erfindung der Architekten. Er ist maschinengerecht und nicht menschengerecht.
    </p>
    <p>Die Menschen haben nicht nur Augen, um sich an Sch&ouml;nem zu erfreuen, und Ohren, um Sch&ouml;nes zu h&ouml;ren,
    und Nasen, um Sch&ouml;nes zu riechen. Der Mensch hat auch einen Tastsinn f&uuml;r H&auml;nde und F&uuml;&szlig;e.</p>
		<p>
		Wenn der moderne Mensch gezwungen wird, auf asphaltierten, betonierten, geraden Fl&auml;chen
    zu gehen, so wie sie in den Designerb&uuml;ros gnadenlos mit dem Lineal konzipiert werden,
    entfremdet von nat&uuml;rlicher Erdbeziehung und Erdber&uuml;hrung,
    so stumpft ein entscheidender Bestandteil des Menschen ab, mit katastrophalen Folgeerscheinungen
    f&uuml;r die Psyche, das seelische Gleichgewicht, das Wohlbefinden und die Gesundheit des Menschen.
		</p>
	  <p><a href="javascript:showPic(1)"><img src="images/khw/khw_3haut_2.jpg" alt=""></a></p>
		<p>
    Der Mensch verlernt zu erleben und wird seelisch krank.
    </p>
		<p>
		Ein belebter, unebener Fu&szlig;boden bedeutet eine Wiedergewinnung der Menschenw&uuml;rde,
    die dem Menschen im nivellierenden St&auml;dtebau entzogen wurde.
		</p>
		<p>Der unebene Wandelgang wird zur Symphonie, zur Melodie f&uuml;r die F&uuml;&szlig;e. Er
    bringt den ganzen Menschen in Schwung.</p>
		<p>
		Architektur soll den Menschen erheben und nicht erniedrigen.
		</p>
		<p>
		<a href="javascript:showPic(2)"><img src="interface/white/gr8.png" alt="image" width="78" height="83" /></a> Man wird gerne auf dem unebenen Boden auf und ab gehen, um sich zu erholen und um das menschliche Gleichgewicht wiederzufinden.
		</p>
		
		<p>
		<em>Hundertwasser, April 1991</em>
		</p>
		
<!-- START::Mediaplayer -->
<div class="newsItem">
<a href="javascript:void(0);" onclick="window.open('/mediaplayer/?file=D-Der unebene Boden', 'mediaplayer', 'width=640,height=480,status=no,scrollbars=no,resizable=no');" style="cursor: pointer;">
<table border="0">
 <tr><td align="center"><img src="mediaplayer/covert5-0.gif" alt="" border="0"></td></tr>
 <tr><td style="font-size: 11px;">Der unebene Boden</td></tr>
</table>
</a>
</div>
<!-- END::Mediaplayer -->
...
<div id="containerRight">
	<p><a href="deutsch/ausstellungen/index.php">Ausstellungen</a></p>
	<ul>
<li><a href="deutsch/ausstellungen/hw_im_khw.php">Hundertwasser im KunstHausWien</a><ul><li><a href="deutsch/ausstellungen/khwrolle.php">Zur Rolle des KunstHausWien</a></li><li><a href="deutsch/ausstellungen/khwhaut.php">Die dritte Haut im dritten Bezirk</a></li><li class="active"><a href="deutsch/ausstellungen/khwboden.php">Der unebene Boden</a></li><li><a href="deutsch/ausstellungen/hundertwasser-ausstellung.php">Aus der Hundertwasser Ausstellung im KunstHausWien</a></li></ul></li><li><a href="deutsch/ausstellungen/ausstellungsprogramm.php">Ausstellungsprogramm</a></li><li><a href="deutsch/ausstellungen/Wcd47b505e67a0.htm">Ausstellungen Archiv</a></li> 
	</ul>
</div> <!-- /containerRight --> <!-- /containerRight -->
