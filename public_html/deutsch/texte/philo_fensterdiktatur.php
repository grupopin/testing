...
<head>
<title>Philosophie - Die Fensterdiktatur und das Fensterrecht &middot; Hundertwasser</title>
...
<!--
	...
	picdesc[0]= "Wohnhausanlage der Gemeinde Wien, 1983-86";	
	picdesc[1]= "764A 2 BIS 13 SCHWIMMENDE FENSTER, Japanischer Farbholzschnitt, 1979";	
	picdesc[2]= "Wohnhausanlage der Gemeinde Wien, 1983-86";	
	picdesc[3]= "711/I FENSTERRECHTSDEMONSTRATION ANDERGASSE, Wien, 1974";	

	var picpath = new Array();
	picpath[0]= "deutsch/texte/images/hundertwasser/philo/hundertwasser034_2_2.jpg";	
  picpath[1]= "deutsch/texte/images/hundertwasser/philo/hundertwasser034_2.jpg";	
	picpath[2]= "deutsch/texte/images/hundertwasser/philo/hundertwasser036.jpg";	
	picpath[3]= "deutsch/texte/images/hundertwasser/philo/hundertwasser032.jpg";	
...
<link rel="up" title="Nach oben" href="#top" />
</head>
...
<div id="navigation">
  ...
  <div id="nav_ballDiv" ><img src="interface/largemenu/ball_2_b.png" width="44" height="39" alt="" /></div>
	<div id="nav_titDiv"><a href="deutsch/texte/philosophie.php"><img src="interface/largemenu/title_d_2.png" width="245" height="37" alt="" /></a></div>
...
<div id="contentwrapper">
	...
	<h2>Die Fensterdiktatur und das Fensterrecht</h2>
	
 	<div class="newsItem alternative">
 	
  	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/philo/hundertwasser034_3_small.jpg" alt=""></a></p>		
<p>Die einen behaupten, die H&auml;user bestehen aus Mauern. Ich sage, die H&auml;user bestehen aus Fenstern. </p>
<p>Wenn in einer Stra&szlig;e verschiedene H&auml;user nebeneinanderstehen, mit verschiedenen Fenstertypen, d. h. Fenster-Rassen, zum Beispiel ein Jugendstilhaus mit Jugendstilfenstern, daneben ein modernes Haus mit schmucklosen rechteckigen Fenstern, daneben ein Barockhaus mit barocken Fenstern, so hat niemand etwas dagegen. </p>
<p>Wenn jedoch diese drei Fenstertypen der drei H&auml;user zu einem Haus geh&ouml;ren, wird das als Versto&szlig; gegen die Rassentrennung der Fenster empfunden. Warum? Jedes Fenster hat doch einzeln f&uuml;r sich seine Lebensberechtigung. </p>


 	<p><a href="javascript:showPic(1)"><img src="images/hundertwasser/philo/hundertwasser034_2_small.jpg" alt=""></a></p>

		<p>Nach dem herrschenden Regelkodex ist es jedoch so: Wenn die Fenster-Rassen gemischt werden, wird gegen die Fenster-Apartheid versto&szlig;en. Die Apartheid der Fenster-Rassen mu&szlig; aufh&ouml;ren. Denn die Repetition immer gleicher Fenster nebeneinander und &uuml;bereinander wie im Rastersystem ist ein Merkmal der Konzentrationslager. In den neuen Geb&auml;uden der Satellitenst&auml;dte und in den neuen Verwaltungsgeb&auml;uden, Banken, Spit&auml;lern, Schulen ist die Nivellierung der Fenster unertr&auml;glich. </p>
  </div>
  
 	<div class="newsItem">
   	
   <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/philo/hundertwasser036_small.jpg" alt=""></a></p> 
   
  	    <p>Das Individuum, der einzelne, immer andersgeartete Mensch wehrt sich gegen diese gleichmachenwollende Diktatur passiv und aktiv je nach Konstitution: mit Alkohol und Drogensucht, Stadtflucht, Putzwahn, Fernsehabh&auml;ngigkeit, unerkl&auml;rlichen k&ouml;rperlichen Beschwerden, Allergien, Depressionen bis zum Selbstmord oder aber mit Aggression, Vandalismus und Verbrechen. </p>

		<p><a href="javascript:showPic(3)"><img src="images/hundertwasser/philo/hundertwasser032_small.jpg" alt=""></a></p>

	 <p>Ein Mann in einem Mietshaus mu&szlig; die M&ouml;glichkeit haben, sich aus einem Fenster zu beugen und - so weit seine H&auml;nde reichen - das Mauerwerk abzukratzen. Und es mu&szlig; ihm gestattet sein, mit einem langen Pinsel - so weit er reichen kann - alles au&szlig;en zu bemalen, so da&szlig; man von weitem , von der Stra&szlig;e sehen kann: Dort wohnt ein Mensch, der sich von seinen Nachbarn, den einquartierten versklavten Normmenschen, unterscheidet. </p>
		<p class="reference">Hundertwasser, 22. Januar 1990</p>
	<p><a href="pdf/fensterrecht.pdf"><strong>PDF</strong>-Download</a></p>  
	</div>
...
<div id="containerRight">
	<p><a href="deutsch/texte/philosophie.php">Manifeste, Texte, Essays</a></p>
	<ul>
    	<li><a href="deutsch/texte/philo_verschimmelungsmanifest.php">Verschimmelungs-<br/>manifest</a></li>
    	<li class="active"><a href="deutsch/texte/philo_fensterdiktatur.php">Fensterdiktatur- Fensterrecht</a></li>
    	<li><a href="deutsch/texte/philo_misstaende.php">Es gibt keine Mi&szlig;st&auml;nde der Natur</a></li>
    </ul>
</div>

</div> <!-- /wrapper -->
<div id="jump"><a href="#top" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('toparrow','','interface/totop3.gif',1)"><img src="interface/totop0.gif" title="Zum Seitenanfang" name="toparrow" width="48" height="50" alt="" /></a></div>
