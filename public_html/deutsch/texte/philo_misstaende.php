...
<head>
<title>Philosophie - Es gibt keine Mi&szlig;st&auml;nde der Natur &middot; Hundertwasser</title>
...
<!--
	...
	picdesc[0]= "<p>738 Gras f&uuml;r die, die auf den Lande weinen, 1974</p>";	

	var picpath = new Array();
	picpath[0]= "deutsch/texte/images/hundertwasser/philo/okologie-gen_lrg.jpg";	
...
<div id="contentwrapper">
		...
		<div id="content">
	  		<h2>Es gibt keine Mi&szlig;st&auml;nde der Natur. <br/>
       Es gibt nur Mi&szlig;st&auml;nde des Menschen.</h2>

		<div class="newsItem alternative">
<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/philo/okologie-gen.jpg" width="237" height="311" alt=""></a></p>
        <p> Wenn der Mensch glaubt, die Natur korrigieren zu m&uuml;ssen, ist es jedesmal ein nicht wiedergutzumachender Fehler. Es sollte nicht einer Gemeinde zur Ehre gereichen, wieviel selbstgewachsene Natur sie zerst&ouml;rt, sondern es sollte vielmehr f&uuml;r eine Gemeinde Ehrensache sein, soviel wie m&ouml;glich von ihrer nat&uuml;rlichen Landschaft zu sch&uuml;tzen. Der Bach, der Flu&szlig;, der Sumpf, die Aulandschaft in ihrer gottgewollten Beschaffenheit m&uuml;ssen uns heilig und unantastbar sein.</p>


		<p> Bachregulierungen bringen nur B&ouml;ses, was uns teuer zu stehen kommt: Absinken des Grundwassers, Absinken der Waldgrenze um bis zu 100 Meter, Versteppung gro&szlig;er Gebiete, kein Regenerieren des Wassers, das zu schnell abflie&szlig;t. Die Aulandschaft kann ihre Schwammt&auml;tigkeit - Aufsaugen von zuviel Wasser und langsames Abgeben bei Trockenheit wie eine gute Sparkasse in Notzeiten - nicht mehr erf&uuml;llen. Der regulierte Bach wird zum Abwasserkanal. Fischsterben und keine Fische im Bach, weil sie nicht durch den regulierten Kanal k&ouml;nnen. Hochwasser mit verheerenden Folgen erst recht nach der Regulierung, weil zuviel Wasser zu schnell abflie&szlig;t, in gro&szlig;en Mengen zusammenkommt, ohne von der Erde und der Vegetation aufgesaugt und abgefangen werden zu k&ouml;nnen. </p>

  	    <p>Nur ein hoch- und unregelm&auml;&szlig;ig flie&szlig;ender Bach mit baumbestandenem Ufer kann reines Wasser erzeugen, den Wasserhaushalt regulieren und den Fisch- und Tierbestand erhalten zum Nutzen des Menschen und seiner Landwirtschaft. Jetzt, fast zu sp&auml;t, erkennt man diese uralte Weisheit, sprengt einbetonierte, geradlinig gemachte Flu&szlig;- und Bachl&auml;ufe, um den vorherigen unregelm&auml;&szlig;igen Zustand wiederherzustellen. Welch Ironie! Warum also den Bach regulieren, wenn man ihn nachher wieder entregulieren mu&szlig;?</p>
 	<p class="reference">Hundertwasser, Mai 1990</p> 
 	<p><a href="pdf/keine_missstaende_der_natur.pdf"><strong>PDF</strong>-Download</a></p> 	 
 	</div>
...
<div id="containerRight">
	...
	<ul>
    	...
    	<li><a href="deutsch/texte/philo_fensterdiktatur.php">Fensterdiktatur- Fensterrecht</a></li>
    	<li class="active"><a href="deutsch/texte/philo_misstaende.php">Es gibt keine Mi&szlig;st&auml;nde der Natur</a></li>
    </ul>
</div>
