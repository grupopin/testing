...
<head>
<title>Kawakawa Public Toilet &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>Hundertwasser with the architecture model of the Kawakawa Public Toilet, New Zealand, 1998</h2>Photo: Richard Smart";	
	picdesc[1]= "<h2>Kawakawa Public Toilet, 1999</h2>Photo: Malcolm Pullmann";		
	picdesc[2]= "<h2>Kawakawa Public Toilet, New Zealand, 1999</h2>Photo: Richard Smart";		
	picdesc[3]= "<h2>Kawakawa Public Toilet, New Zealand, 1999</h2>Photo: Richard Smart";		


	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/toilette_kawakawa/arch119_toilkawakawa_11.jpg";	
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/toilette_kawakawa/arch_0119.jpg";
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/toilette_kawakawa/toilette1.jpg";	
	picpath[3]= "english/oeuvre/arch/images/hundertwasser/architektur/toilette_kawakawa/toilette2.jpg";	
...
<div id="contentwrapper">
	...
	<div style="padding: 175px 75px 0 0; float: right;">
	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/toilette_kawakawa/arch119_toilkawakawa_11_sml.jpg" width="230" height="158" alt=""></a>
	<br/><br/>
	<a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/toilette_kawakawa/arch_0119.small.jpg" vspace="15" alt=""></a></p>  </div>
	
	<div style="padding: 40px 0 0 35px; width: 400px;">
  		<h2>Kawakawa Public Toilet</h2>
  		<h3>1999</h3>
  		<p><i>Kawakawa, New Zealand</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/toilette_kawakawa/toilette1-thumb.jpg" alt="Toilette" width="100" height="124" class="inlineimg"/style="margin-top:3px;"></a>The local businessmen's association approached Hundertwasser requesting that he redesign          this building dating back to the 1960s. Taking on the project allowed Hundertwasser to          present Kawakawa with a token of his art. During the reconstruction process it was          discovered that the necessary renovation measures would be more extensive than          originally planned. </p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/toilette_kawakawa/toilette2-thumb.jpg" alt="Toilette" width="100" height="100" class="inlineimg" style="margin-top:3px;"/>Hundertwasser became personally involved in the refurbishment, for  example he created the columns by assembling Asian ceramics. He had a  wall of bottles built as a reference to the &quot;bottlehouse&quot; on his own  property in New Zealand. He also took charge of planting trees on the  roof. He chose a plane tree for the front of the building and a tulip  tree for the back. Maori arists and the artist Peter Yates were also  involved in designing the project. The toilets were awarded the  &quot;Premier Creative Places Award 2000&quot; on July 10, 2000, on the occasion  of the Local Government New Zealand Annual Conference at Christchurch.</a></p>
  </div>
