...
<head>
<title>Housing Complex &quot;In the Meadows&quot; &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>In the Meadows Bad Soden, 1990-1993</h2>Photo: Wonge Bergmann";	//ARCH 76
	picdesc[1]= "<h2>In the Meadows Bad Soden, 1990-1993</h2>Photo: Christa Kreuter";  //ARCH 76
	picdesc[2]= "<h2>In the Meadows Bad Soden, 1990-1993</h2>Photo: Christa Kreuter";
	picdesc[3]= "<h2>In the Meadows Bad Soden, 1990-1993</h2>Photo: Peter Mosdzen";
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_10_WB.jpg";	
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_2.jpg";	
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_08_PM.jpg";	
	picpath[3]= "english/oeuvre/arch/images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_06_PM.jpg";	
...
<div id="contentwrapper">
	...
	<div style="padding: 212px 95px 0 0; float: right;">
   <a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_2_sml.jpg" vspace="10" width="193" height="255" alt=""></a><br />
   <br/>
 	 <a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/wohnanlage_inderwiesen/arch_0076_10_WB_sml.jpg" width="192" height="255" alt=""></a>
    </div>
  	<div style="padding: 40px 0 0 40px; width: 400px;">
  		<h2>In the Meadows Bad Soden</h2>
  		<h3>1990-1993</h3>
    <p><em>Quellenpark 38, <br/>
      65812 Bad Soden/Taunus, Germany</em></p>
  	    
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/wohnanlage_inderwiesen/wiesen1-thumb.jpg" alt="Wiesen" width="120" height="120" class="inlineimg" style="margin-top:3px;"/></a>Hunderwasser's architecture seemed ideal for a building which would be  harmoniously adapted to the environs and nature. In the heart of the  city, between Wilhelmspark and &quot;Springs Park&quot;, the building complex  designed by Hundertwasser and planned by Peter Pelikan was realised,  with the surrounding buildings also integrated and refurbished, among  them a house under protection as an historic monument, built in 1722,  the first Soden spa hall, called Haus Bockenheimer.</p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/wohnanlage_inderwiesen/wiesen2-thumb.jpg" alt="Wiesen" width="120" height="120" class="inlineimg-alt" style="margin-top:3px;"/></a>In order to secure the difficult construction grounds without  encroaching on the groundwater currents in the protected area of the  source of the mineral spring, 250 concrete columns had to be sunk up to  15 m deep to serve as supportive elements. With 25,000 cubic meters of  structured space, the complex is about as large as the Hundertwasser  House in Vienna. Like the Viennese project, the complex in Bad Soden  was brick-built with concrete ceilings. Five stairwells lead to the  apartments situated on nine levels. The apartments, some of which take  up several storeys, are designed as &quot;houses within the house&quot;. They  have individual ground plans, and every dwelling area has terraces with  greenery or roof gardens. The arrangement of the various units of the  building, their varying heights and forms, make the complex resemble a  fortress.</p>
  </div>
</div>
