...
<head>
<title>&ldquo;Mop&rdquo; Maishima Incineration Plant &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>„MOP“ Maishima Incineration Plant, Osaka, 1997-2001</h2>Photo: HU-NET Corporation, Osaka";	
	picdesc[1]= "<h2>„MOP“ Maishima Incineration Plant, Osaka, 1997-2001</h2>Photo: HU-NET Corporation, Osaka";	
	picdesc[2]= "<h2>„MOP“ Maishima Incineration Plant, Osaka, 1997-2001</h2>Photo: HU-NET Corporation, Osaka";	
	picdesc[3]= "<h2>„MOP“ Maishima Incineration Plant, Osaka, 1997-2001</h2>Photo: HU-NET Corporation, Osaka";	
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/muell_maishima/muell_maishima30.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/muell_maishima/muell_maishima33.jpg"
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/muell_maishima/MOP-1.jpg"
	picpath[3]= "english/oeuvre/arch/images/hundertwasser/architektur/muell_maishima/MOP-3.jpg"
...
<div id="contentwrapper">
	...
	<div style="padding: 225px 80px 0 0; float: right;">
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/muell_maishima/muell_maishima30_sml.jpg" width="255" height="201" alt=""></a><br/>
  <br />
  <a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/muell_maishima/muell_maishima33_sml.jpg" width="255" height="204" vspace="15" alt=""></a></div>
  <div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>&quot;Mop&quot; Maishima Incineration Plant</h2>
		<h3>1997-2001</h3>
        <p><i>2-1-1, Hokkoushiratsu, Konohana-kud, Osaka, Japan</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/muell_maishima/MOP-1.png" alt="" width="100" height="96" class="inlineimg"/></a>Hundertwasser was commissioned to architecturally refurbish and  redesign the entire incineration plant, along with its 120-metre  chimney strack. The plant was planned by the Japanese architectural  team Showa Sekkei within the context of the &quot;Maishima Island Project&quot;  for the city of Osaka. The incinerator is equipped with the latest and  most advanced filter systems.</p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/muell_maishima/MOP-3.png" alt="" width="100" height="67" class="inlineimg"/></a>Three stories were designed as an adventure world with a didactic  component in order to make visitors, especially school children,  conscious of the problems of waste and to encourage their cooperation  in working towards a garbage-free society.</p>
  </div>
