...
<head>
<title>Children's Day-Care Centre Heddernheim &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>Children's Day-Care Centre Heddernheim, 1988-1995</h2>Photo: Miguel Raurich";	 //ARCH 89
	picdesc[1]= "<h2>Children's Day-Care Centre Heddernheim, 1988-1995</h2>Photo: Miguel Raurich";
	picdesc[2]= "<h2>Children's Day-Care Centre Heddernheim, 1988-1995</h2>Photo: Peter Mosdzen";
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/kindertagesstaette/arch_0089_1.jpg";	
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/kindertagesstaette/arch_0089_RA.jpg";
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/ARCH_089_Mosdzen_big.jpg";
...
<div id="contentwrapper">
	...
	<div style="padding: 190px 100px 0 20px; float: right;"><a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/kindertagesstaette/arch_0089_RA_sml.jpg" width="201" height="255" alt=""></a></div>
	<div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Children's Day-Care Centre Heddernheim</h2>
		<h3>1988-1995</h3>
  	    <p><i>Kupferhammer 93, 60439 Frankfurt, Germany</i></p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/ARCH_089_Mosdzen_small.jpg" alt="Kindertagesstaette Heddernheim" width="115" height="120" class="inlineimg" style="margin-top:4px;"/></a>On the initiative of the chief of the cultural authority of the City of Frankfurt am Main,          Hilmar Hoffmann, and the chief of the building authority, Hans-Erhard Haverkampf,          Hundertwasser was asked to design a day-care centre in 1986 on the occasion of an initiative          to create more kindergarten facilities. As part of a development project for the northern          districts of the city, the city government donated a plot at Urselbach, a naturally restored          brook on the site of an abandoned factory. After Hundertwasser's design and the model of the          day-care centre were approved by the city, Alderman Haverkamp commissioned Hundertwasser to          design an integrative school, whose construction was planned to take place on the other          side of the brook, but which was not realised.</p>
  </div>
</div>
