...
<head>
<title>The Forest Spiral Of Darmstadt &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>The Forest Spiral of Darmstadt, 1998-2000</h1>Photo: Peter Mosdzen";	
	picdesc[1]= "<h1>The Forest Spiral of Darmstadt, 1998-2000</h1>Photo: Peter Mosdzen";	
	picdesc[2]= "<h1>The Forest Spiral of Darmstadt, 1998-2000</h1>Photo: Hundertwasser Archive";	
	picdesc[3]= "<h1>The Forest Spiral of Darmstadt, 1998-2000</h1>Photo: Christa Kreuter";	
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_09.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_13.jpg";		
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_01.jpg";		
	picpath[3]= "english/oeuvre/arch/images/hundertwasser/architektur/wald_spirale/arch_waldspirale_02.jpg";		
...
<div id="contentwrapper">
  ...
  <div style="padding: 40px 0 0 40px; width: 420px;">
  		<h2>The Forest Spiral of Darmstadt</h2>
		<h3>1998-2000</h3>
        <p><em>B&uuml;rgerparkviertel; Friedberger Stra&szlig;e / Bad Nauheimer Stra&szlig;e, 64293 Darmstadt, Germany</em>
        <p>
		<p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/wald_spirale/waldspirale1-thumb.jpg" alt="Waldspirale" width="42" height="120" class="inlineimg" style="margin-top:3px;"/></a>The Bauverein Darmstadt (Darmstadt Building Association) commissioned Hundertwasser to      design a housing complex with 105 residential units in the B&uuml;rgerpark area of Darmstadt.      Hundertwasser's idea was to plan the building so that it rose up on the site in the form of      an afforested spiral.</p>
		<p>&nbsp;</p>
		<p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/wald_spirale/waldspirale2-thumb.jpg" alt="Waldspirale" width="63" height="100" class="inlineimg-alt" style="margin-top:2px;"/></a>The building begins to rise on the southwestern corner of the site in      a constantly climbing meadow to a final height of nine stories on the southeastern corner of      the site, where a twelve-story tower rises up 41 metres providing a unique accent. The      facades were designed by Hundertwasser as an allegory of the earth's strata, of the sediment      that has been deposited over millions of years.</p>
  </div>
