...
<head>
<title>Quixote Winery &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Quixote Winery, Napa Valley, 1992-1999</h1>Photo: Quixote Winery";	
	picdesc[1]= "<h1>Quixote Winery, Napa Valley, 1992-1999</h1>Photo: Quixote Winery";
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/quixote_winery/quixote_winery_01_big.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/quixote_winery/quixote_winery_02_big.jpg";
...
<div id="contentwrapper">
	...
	<div style="padding: 195px 70px 0 0; float: right;">
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/quixote_winery/quixote_winery_01_sml.jpg" alt=""></a><br/>
	</div>
	<div style="padding: 40px 0 0 50px; width: 400px;">
  		<h2>Quixote Winery</h2>
		<h3>1992-1999</h3>
        <p><em>6126 Silverado Trail, Napa Valley, CA 94558, California, U.S.</em></p>
        <p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/quixote_winery/quixote_winery_02_sml.jpg" alt="Winery" class="inlineimg" style="margin-top:4px;"/></a>The building is completely overgrown with nature to wander and walk  upon all parts of the roof. A multiplication of nature as an answer to  urban distruction.</p>
        <p><a href="http://www.quixotewinery.com/" target="_blank">www.quixotewinery.com</p>
  </div>
