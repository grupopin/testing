...
<head>
<title>Ronald McDonald House &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Ronald McDonald House, Essen, 2004-2005</h1>Photo: Peter Mosdzen";	
	picdesc[1]= "<h1>Ronald McDonald House, Essen, 2004-2005</h1>Photo: Peter Mosdzen";	
	picdesc[2]= "<h1>Ronald McDonald House, Essen, 2004-2005</h1>Photo: Peter Mosdzen";	
	picdesc[3]= "<h1>Ronald McDonald House, Essen, 2004-2005</h1>Photo: Alexander Proefrock";	
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/ronald_mcdonald/donald_03.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/ronald_mcdonald/donald_04.jpg";			
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-1.jpg";			
	picpath[3]= "english/oeuvre/arch/images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-2.jpg";			
...
<div id="contentwrapper">
	...
	<div style="padding: 180px 70px 0 0; float: right;">
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/ronald_mcdonald/donald_03_sml.jpg" width="170" height="255" alt=""></a><br/><br/>
  <a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/ronald_mcdonald/donald_04_sml.jpg" width="255" height="169" vspace="15" alt=""></a></div>
  <div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Ronald McDonald House</h2>
		  <h3>2004-2005</h3>
        <p><em>Unterm Sternenzelt 1, 45147 Essen, Germany</em></p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-1.png" alt="" width="69" height="100" class="inlineimg"/style="margin-top:4px;"></a>In August 1999 Hundertwasser drew the initial sketches for this centre  built for the families of children being treated for serious medical  conditions at the university clinic in Essen. It is one of fourteen  Ronald McDonald houses in Germany, in which family members are given an  opportunity to feel at home while their children are undergoing  extended clinical treatment. Hundertwasser chose a site in the middle  of Gruga Park, accepting the commission because he was interested not  only in the social and human components, but also in demonstrating that  the building could be constructed without destroying nature, indeed,  that after the building was completed there would be even more nature  than before.</p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(3)"><img src="images/hundertwasser/architektur/ronald_mcdonald/Ronald-McDonald-2.png" alt="" width="87" height="100" class="inlineimg"/></a>These were also the conditions that made it possible to locate the  building in the middle of a nature preserve in one of Germany's most  famous parks. The building was created in harmony with both nature and  man's individual</p>
  </div>
