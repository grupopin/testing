...
<head>
<title>The Ship Regentag &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Ship Regentag before the coating with ferro-cement</h1>Photo: Richard Smart";	
	picdesc[1]= "<h1>Ship Regentag after coating with ferro-cement, 2001</h1>Photo: Richard Smart";	

	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/regentag/arch_0012_2.jpg";	
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/regentag/arch_0012_3.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content">
	...
	<p>Acquired in 1967 in Palermo as a Sicilian-Tunisian transport ship by the name of &ldquo;San Giuseppe T&rdquo;, it was sailed to Venice by Hundertwasser and captain Mimmo. Seven years of refurbishing with Captain Antonio in the shipyards of Palermo, Pellestrina, Portegrandi, Malcontenta, Portoferraio, La Goulette and Malta were Hundertwasser&rsquo;s first years of practical apprenticeship in architecture. There were similar problems and discussions as with his later architecture.</p>
	</div>
	
	<div class="newsItem">	
	<p>Hundertwasser lengthened the ship from 12 to 15 meters, rounded out the hull, set two masts, redesigned the bow and stern and gave the superstructure a creative, asymmetrical appearance.</p>
	<p>For Hundertwasser the &ldquo;Regentag&rdquo; was a significant phase of his life. It was his home, his country, his headquarters. He lived and painted on it for ten years. The ship &ldquo;Regentag&rdquo; has turned out to be Hundertwasser&rsquo;s third name, after Friedensreich and &ldquo;Dunkelbunt&rdquo; (Colours Glowing in the Dark). Hundertwasser has been fascinated by ships since he was a child and dreamed up ships in his paintings: The &ldquo;Singing Steamers&rdquo;, the &ldquo;Mouthboats&rdquo;, the portholes, ships from the front, steamer&rsquo;s smokestacks etc. are recurring motifs in his pictures.</p>
	
	<p>After trial voyages to Dalmatia, Sicily, Corsica, Elba, Malta, Tunis, Crete, Rhodes, Cyprus and Israel, the &ldquo;Regentag&rdquo; proved its seaworthiness by a voyage to the Antipodes, sailing in 18 month, under Captain Horst W&auml;chter, with no problems from Venice via Malta, Gibraltar, the West Indies, Panama, the Galapagos and Tahiti to New Zealand. Hundertwasser was himself captain on board the Mediterranean, the Caribbean and on the final stretch Tahiti &ndash; Rorotonga &ndash; Kermadec Islands &ndash; Auckland &ndash; Bay of Islands. 
Since that time the &ldquo;Regentag&rdquo; has been in the care of Captain Andrew Fagan and of Richard Smart.</p>
	</div>

<!-- START::Mediaplayer -->
<div class="newsItem">
<a href="javascript:void(0);" onclick="window.open('/mediaplayer/?file=E-The ship Regentag', 'mediaplayer', 'width=640,height=480,status=no,scrollbars=no,resizable=no');" style="cursor: pointer;">
<table border="0">
 <tr><td align="center"><img src="mediaplayer/covert5-0.gif" alt="" /></td></tr>
 <tr><td style="font-size: 11px;">The Ship &quot;Regentag&quot;</td></tr>
</table>
</a>
</div>
<!-- END::Mediaplayer -->
	...
	<p>In 1999-2000 in Opua, New Zealand, Hundertwasser had the boat coated with ferro-cement, redid the wheel house and decorated the waterline with tiles. All work was done at the Ashby&rsquo;s Boat Yard, Opua, Bay of Islands. It was a necessary renovation after the ship sunk and was rescued in 1995, but also a long-time wish of Hundertwasser.</p>
	<p>In 2004 the &ldquo;Regentag&rdquo; was transported per cargo to Europe and was a part of the exhibition &ldquo;Hundertwasser. Art &ndash; Person  &ndash;  Nature&rdquo; in the former Abbey (Minoritenkloster) in Tulln, Lower Austria. Since that time the &ldquo;Regentag&rdquo; has been lain at anchor there at the Danube.</p>
	</div>
...
<div id="containerRight">
	...
	<ul>
    	...
    	<li><a href="english/oeuvre/arch/arch_architekten.php">Hundertwasser Architects</a></li>
		<li class="active"><a href="english/oeuvre/arch/arch_regentag.php">The Ship &quot;Regentag&quot;</a></li>
  </ul>
</div>
