...
<head>
<titleAltenrhein Indoor Market &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>Altenrhein Indoor Market, 1998-2001</h1>Photo: Herbert Lindemann";	
	picdesc[1]= "<h1>Altenrhein Indoor Market, 1998-2001</h1>Photo: Herbert Lindemann";	
	picdesc[2]= "<h1>Altenrhein Indoor Market, 1998-2001</h1>Photo: Herbert Lindemann";	
	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/markthalle/arch_0123_lindem.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/markthalle/arch123_markthalle_04.jpg";		
	picpath[2]= "english/oeuvre/arch/images/hundertwasser/architektur/markthalle/arch123_markthalle_01.jpg";		
...
<div id="contentwrapper">
	...
	<div style="padding: 195px 80px 0 0; float: right;">
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/markthalle/arch_0123_lindem.small.jpg" alt=""></a></div>
	
	<div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Altenrhein Indoor Market</h2>
		<h3>1998-2001</h3>
        <p><em>Knotternstrasse 2, 9422 Staad am Bodensee, Switzerland</em></p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/markthalle/arch123_markthalle_04_sml2.jpg" alt="Markthalle" width="53" height="100" class="inlineimg" style="margin-top:3px;"/></a>The building was originally designed as a market hall where organic products from the region could be offered for sale.</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><a href="javascript:showPic(2)"><img src="images/hundertwasser/architektur/markthalle/markthalle2-thumb.jpg" alt="Markthalle" width="75" height="100" class="inlineimg-alt" style="margin-top:3px;"/></a>Meanwhile it serves as a setting for cultural events.</p>
  </div>
