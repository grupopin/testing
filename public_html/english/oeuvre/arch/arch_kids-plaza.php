...
<head>
<title>Kids Plaza Osaka &middot; Projects &middot; Architecture &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>Kids Plaza Osaka</h2>A Children's Adventure Architecture, 1996/97</h2>Photo: HU-NET Corporation, Osaka";	
	picdesc[1]= "<h2>Kids Plaza Osaka</h2>A Children's Adventure Architecture, 1996/97</h2>Photo: HU-NET Corporation, Osaka";	
	var picpath = new Array();
	picpath[0]= "english/oeuvre/arch/images/hundertwasser/architektur/kidsplaza_osaka/arch102_kidsplazaosaka.jpg";		
	picpath[1]= "english/oeuvre/arch/images/hundertwasser/architektur/kidsplaza_osaka/arch089_kidsplazaosaka.jpg";	
...
<div id="contentwrapper">
	...
	<div style="padding: 205px 80px 0 0; float: right;">
	<a href="javascript:showPic(0)"><img src="images/hundertwasser/architektur/kidsplaza_osaka/arch102_kidsplazaosaka_sml.jpg" width="255" height="205" alt=""></a></div>
	<div style="padding: 40px 0 0 40px; width: 370px;">
  		<h2>Kids Plaza Osaka - A Children's Adventure Architecture</h2>
  		<h3>1996/97</h3>
        <p><i>2-1-7 Ogimachi, Kita-ku, Osaka 530, Japan</i></p>

		<p>Kids Plaza Osaka is both a playground and a world of adventure for  children. Diverse exhibitions, events and workshops allow children to  discover their world in a playful manner. Hundertwasser took on the  commission to design the Kid's Town, which is located in an atrium  between the fourth and fifth floors and features a spiral tower in its  centre.</p>
		<p><a href="javascript:showPic(1)"><img src="images/hundertwasser/architektur/kidsplaza_osaka/kidsplaza-thumb.jpg" alt="kidsplaza-thumb" width="120" height="103" class="inlineimg" style="margin-top:4px;"/></a>Hundertwasser's adventurous architecture for children is the antipode  of the sterile, computer-controlled unnatural and virtually inhuman  architecture in which children spend a great deal of their time. Here  children can experience the irregular, the organic and creative  diversity in an architecture that inspires their imagination and sense  of adventure - a means of making restitution to children's souls.</p>
  </div>
