...
<head>
<title>Wieland Schmied on Hundertwasser's Painting &middot; Hundertwasser</title>
...
<!--
	...
	picdesc[0]= "<H1>691 IRINALAND OVER THE BALKANS</H1><br/>Mixed Media, Rome, 1969";	

	var picpath = new Array();
	picpath[0]= "english/oeuvre/malerei/images/hundertwasser/malerei/0691_4c.jpg";	
...
<div id="contentwrapper">
   ...
   <div id="content">
      <h2>Wieland Schmied on Hundertwasser's Painting</h2>

 	<div class="newsItem alternative">
 	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/malerei/0691_4c_sml.jpg" alt=""></a></p>
  		<p>A major part of the effect of Hundertwasser&rsquo;s painting is colour. Hundertwasser uses colours instinctively, without associating them with a definite symbolism of even his own invention. He prefers intensive, radiant colours and loves to place complementary colours next to one another to emphasize the double movement of the spiral, for instance.</p>
<p>&nbsp;</p>

		<p>&hellip;Today the position of his painting is singular and unparalleled.</p>
		<p><a href="english/oeuvre/malerei/malerei_schmied.php" style="color: #00DF00;">Wieland Schmied</a></p>
  </div>
...
<div id="containerRight">
	<p><a href="english/oeuvre/malerei/malerei.php">Painting</a></p>		
       <ul>
            <li ><a href="english/oeuvre/malerei/malerei_diespirale.php">The Spiral</a></li>
            <li class="active"><a href="english/oeuvre/malerei/malerei_zitate.php">Wieland Schmied</a></li>
        </ul>    	
