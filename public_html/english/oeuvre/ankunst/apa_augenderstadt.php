...
<head>
<title>Hundertwasser - Augen der Stadt - DasFensterrecht &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>913C EYES OF THE CITY – WINDOW RIGHT</h2><p>Three-dimensional object, 1992</p>";

	var picpath = new Array();
	picpath[0]= "english/oeuvre/ankunst/images/hundertwasser/apa/apa_0289.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content">
	  ...
	  <h2>EYES OF THE CITY <br />WINDOW RIGHT</h2>
	    
 	<div class="newsItem alternative">
 	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/apa/apa_0289_sml.jpg" width="195" height="260" alt=""></a></p>

      <p class="werk">Three-dimensional object, 1992</p>
        <p>This object is based on the architectural design of the KunstHausWien  and is made of wood, acrylic glass, cardboard, stucco and ceramic. It is  painted with watercolours. It was executed according to Hundertwasser’s design  by Alfred Schmid, Klosterneuburg, and  Andreas Bodi, Maria Enzersdorf, in  an edition of 500 specimen.<br />
It shows a facade, not perfectly  straight and flat, but humpy and interrupted by irregular mosaics. A  black-and-white, irregular checkerboard pattern signals the disbanding of the  grid system, its brea­kup. For Hundertwasser windows are the bridge between  inside and outside. Windows are an equivalent of the eyes.</p>
...
<div id="containerRight">
	<p><a href="english/oeuvre/ankunst/angewandtekunst.php">Applied Art</a></p>
            <ul>
                ...
                <li class="active"><a href="english/oeuvre/ankunst/apa_augenderstadt.php">Eyes of the City</a></li>
