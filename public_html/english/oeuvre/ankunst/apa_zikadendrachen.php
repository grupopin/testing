...
<head>
<title>Hundertwasser - Zikadendrachen &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h2>919 CICADA KITE</h2><p>Three-dimensional object, 1989</p>";
	picdesc[1]= "<h2>919 CICADA KITE</h2><p>Three-dimensional object, 1989</p>";
	picdesc[2]= "<h2>919 CICADA KITE</h2><p>Three-dimensional object, 1989</p>";

	var picpath = new Array();
	picpath[0]= "english/oeuvre/ankunst/images/hundertwasser/apa/apa_0306_07.jpg";	
	picpath[1]= "english/oeuvre/ankunst/images/hundertwasser/apa/apa_0306_08.jpg";	
	picpath[2]= "english/oeuvre/ankunst/images/hundertwasser/apa/apa_0306_09.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content" class="wide">
	...
	<p><a href="javascript:showPic(0)"><img src="images/hundertwasser/apa/apa_0306_07_sml.jpg" width="250" height="211" alt=""></a></p>
	<p class="werk">Three-dimensional objects, 1989</p>
	
	<p>For  the creation of the kites the Japanese colour woodcut prints <em>557B Do Not Wait Houses Move</em> and <em>870A</em> <em>Pacific  Raindrop on Tahiti</em>, cut by Tatsuo Kawashima and printed by Akio Shimizu, both  members of the studio Uchida in Kyoto,  were used. The kites were built by Masaaki Sato, Nagoya. </p>
	</div>
	<div class="newsItem">
	<p><a href="javascript:showPic(1)"><img src="images/hundertwasser/apa/apa_0306_08_sml.jpg" width="240" height="201" alt=""></a></p>
	<p>He  created 12 variants, different in form and image, in an edition of 75 specimen  each. </p>
	<p>The idea for these kite objects came from the Goethe Institute in Osaka, which had asked 100 artists from 20 countries to decorate Japanese kites on the occasion of the “Year of the Dragon” (1988). The kites were shown all over the world in the travelling exhibition “Pictures for the Sky”. </p>
	</div>
	
	<div class="newsItem alternative">	
	<p><a href="javascript:showPic(2)"><img src="images/hundertwasser/apa/apa_0306_09_sml.jpg" width="250" height="213" alt=""></a></p>
	<p>Hundertwasser’s  kites are Japanese kites in the traditional shapes of insect kites that  originate from the Nagoya  region. Following local tradition, the cicada kite is equipped with a unari  aerophone instrument, whose taut string sounds the typical cicada chirping in  the wind. Hundertwasser agreed to design a series of kites, consisting of the  12 shapes from Masaaki Sato’s repertoire, among them cicadas, bees,  bumble-bees, horseflies and the circular wanwan kite.</p>
...
<div id="containerRight">
	<p><a href="english/oeuvre/ankunst/angewandtekunst.php">Applied Art</a></p>
            <ul>
                <li><a href="english/oeuvre/ankunst/apa_fallincloud.php">Fall in Cloud</a></li>
                <li class="active"><a href="english/oeuvre/ankunst/apa_zikadendrachen.php">Cicada Kites</a></li>
                <li><a href="english/oeuvre/ankunst/apa_augenderstadt.php">Eyes of the City</a></li>
                <li><a href="english/oeuvre/ankunst/apa_diehoelzer7.php">DieHoelzerSiebeN</a></li>
                <li><a href="english/oeuvre/ankunst/apa_buecher.php">Book Design</a></li>
                <li><a href="english/oeuvre/ankunst/apa_keramikporzellan.php">Porcelain</a></li>
            </ul>
</div>
