...
<head>
<title>Hundertwasser - DIEHOELZERSIEBEN &middot; Hundertwasser</title>
...
<script language="JavaScript" type="text/JavaScript">
	...
	picdesc[0]= "<h1>997 DIEHOELZERSIEBEN</h1><br/>Kunstobjekt und kreatives Spiel, 1992-2004";

	var picpath = new Array();
	picpath[0]= "english/oeuvre/ankunst/images/hundertwasser/apa/apa_hoelzer7.jpg";	
...
<div id="contentwrapper">
  ...
  <div id="content" class="wide">
	<h2>DIEHOELZERSIEBEN</h2>
	
	<div class="newsItem alternative">
	<p><img src="images/hundertwasser/apa/apa_hoelzer7_sml.jpg" width="230" height="270" alt=""></a></p>
	<p class="werk">Art object and creative architecture game, 1992-2004</p>
	<p style="height: 10px;"></p>
	<p style="font-style: italic;">"DIE HOELZERSIEBEN is an architecture game, building blocks for adults who still can and still want to dream and for children who have not yet had their creativity taken away from them."<br/>
	<span class="reference">Hundertwasser, November, 1999</span></p>

	<p style="height: 10px;"></p>
	<p>Hundertwasser had this idea for a creative art and architecture game that would preoccupy him time and again from 1992 until shortly before his death. Many years passed before the right kind of wood from sustainable forestry was found and the wood pieces could be printed in an elaborate silk-screen printing process that involved 130 print runs in seven different colours. The pieces of wood had to be picked up individually by hand several times, resulting in each specimen becoming an original and unique object. DIEHOELZERSIEBEN were produced in a limited first edition of 2000. This art and architecture game offers countless possibilities to arrange animated building blocks into “architecture for you and me.”</p>
...
<div id="containerRight">
	<p><a href="english/oeuvre/ankunst/angewandtekunst.php">Applied Art</a></p>
            <ul>
                ...
                <li class="active"><a href="english/oeuvre/ankunst/apa_diehoelzer7.php">DieHoelzerSiebeN</a></li>
