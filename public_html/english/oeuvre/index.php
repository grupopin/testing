...
<head>
<title>Hundertwasser Werk</title>
...
<![endif]-->
<script language="javascript" type="text/javascript" src="scripts/jquery.tooltip.js"></script>
...
function changeMenuColor(lnkId)
{
	var clnk = document.getElementById("lnk"+lnkId);
	clnk.className = "greenLink";
	
}

function resetMenuColor(lnkId)
{
	var clnk = document.getElementById("lnk"+lnkId);
	clnk.className = "WerkCover";

}
</script>
</head>

<body id="hundertwasser" class="black">	
...
<div id="wrapper">
  <!--<div class="style1"><a href="../../english/hundertwasser/cover.php">English</a></div>-->
  <!-- Navigation -->
...
<div id="contentwrapper">
  ...
  <div id="content" class="spirale">

	<div id="spiraleDiv1"></div>
	<div id="spiraleDiv2"><a href="english/oeuvre/arch/architektur.php" id="lnk0" class="WerkCover">Architecture</a></div>
	<div id="spiraleDiv3"><a href="english/oeuvre/malerei/malerei.php" id="lnk1"  class="WerkCover">Painting</a></div>
	<div id="spiraleDiv4"><a href="english/oeuvre/eco/oekologie.php" id="lnk2"  class="WerkCover">Ecology</a></div>
	<div id="spiraleDiv5"><a href="english/oeuvre/graphic/graphik.php" id="lnk3"  class="WerkCover">Graphic</a></div>
	<div id="spiraleDiv6"></div>
	<div id="spiraleDiv7"><a href="english/oeuvre/ankunst/angewandtekunst.php" id="lnk4"  class="WerkCover">Applied Art</a></div>
	<div id="spiraleDiv8"><a href="english/oeuvre/tapis/tapisserie.php" id="lnk5"  class="WerkCover">Tapestry</a></div>
	
	<div id="spiraleBkg">
	  <img name="spirale_einzeln" src="interface/hundertwasser/spirale/spirale_solo_2.jpg" width="509" height="608" id="spirale_einzeln" usemap="#m_spirale_einzeln" alt="Hundertwasser The Oeuvre" />
	  <map name="m_spirale_einzeln" id="m_spirale_einzeln">
	  <area shape="rect" coords="288,476,362,553" href="english/oeuvre/ankunst/angewandtekunst.php" title="Applied Art" alt="Applied Art"  onmouseover="changeMenuColor(4)" onmouseout="resetMenuColor(4)" />
	<area shape="rect" coords="385,123,446,210" href="english/oeuvre/graphic/graphik.php" title="Graphic" alt="Graphic"  onmouseover="changeMenuColor(3)" onmouseout="resetMenuColor(3)"/>
	<area shape="rect" coords="173,228,247,340" href="english/oeuvre/eco/oekologie.php" title="Ecology" alt="Ecology"  onmouseover="changeMenuColor(2)" onmouseout="resetMenuColor(2)"/>
	<area shape="rect" coords="80,74,191,129" href="english/oeuvre/malerei/malerei.php" title="Painting" alt="Painting"  onmouseover="changeMenuColor(1)" onmouseout="resetMenuColor(1)"/>
	<area shape="rect" coords="112,374,188,487" href="english/oeuvre/arch/architektur.php" title="Architecture" alt="Architecture"  onmouseover="changeMenuColor(0)" onmouseout="resetMenuColor(0)" />
	<area shape="rect" coords="389,308,465,400" href="english/oeuvre/tapis/tapisserie.php" alt="Tapestry"  onmouseover="changeMenuColor(5)" onmouseout="resetMenuColor(5)"/>
	</map>
	</div>

	<div id="menuPhoto" ><img src="images/hundertwasser/hw_cover_arch_border.jpg" alt="image" width="300" height="471" /></div>
