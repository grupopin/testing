...
<head>
<title>&Ouml;kologie &middot; Hundertwasser</title>
...
<script type="text/javascript">
	...
	picdesc[62]= "<p>Tree planting in front of the Rosenthal Porcelain Factory in Selb, 1981</p>";
	picdesc[64]= "<p>Tree planting in Washington, Judiciary Square, November, 1980</p>";

	var picpath = new Array();
	picpath[62]= "english/oeuvre/eco/images/hundertwasser/oeko/hw_tree.jpg";	
	picpath[64]= "english/oeuvre/eco/images/hundertwasser/oeko/1980_washington.jpg";	
...
<body id="hundertwasser" onload="MM_preloadImages('interface/totop1.gif')">
...
<div id="contentwrapper">
	...
	<h2>Ecology</h2>
 	...
 	<div class="newsItem alternative"> 	
		<p class="reference"><a href="javascript:showPic(62)"><img src="images/hundertwasser/oeko/hw_tree_sml.jpg" width="250" height="180" alt=""></a></p>
		<p>Ecology is the touchstone of Hundertwasser's sensitivity, the sensitive  cytoplasm of his fifth skin. Hundertwasser is naturally &quot;green&quot;, just  as he is naturally a painter, Austrian, cosmopolitan or pacifist. Since  his earliest childhood he had displayed a hypersensitivity to his  surroundings. Nature is the supreme reality, the source of universal  harmony; his immense respect for nature very soon aroused in him the  desire to protect it against the attacks made on it by man and industry.</p>

	</div>
  
 	<div class="newsItem">
	   <p><a href="javascript:showPic(64)"><img src="images/hundertwasser/oeko/1980_washington_sml.jpg" width="320" height="208" alt=""></a></p>
	  <p class="reference">from: Pierre Restany - <em>The Power of Art, Hundertwasser, The Painter-King with the Five Skins</em>, Cologne, 1998</p>
  </div>
...
<div id="containerRight">
    ...
    <ul>
    	<li><a href="english/oeuvre/malerei/malerei.php">Painting</a></li>	
	  	<li><a href="english/oeuvre/graphic/graphik.php">Graphic</a></li>
        ...
        <li><a href="english/oeuvre/arch/architektur.php">Architecture</a></li>
    	<li class="active"><a href="english/oeuvre/eco/oekologie.php">Ecology</a></li>
        <ul>
            <li><a href="english/oeuvre/eco/oeko_poster.php">Original environmental posters</a></li>
            <li><a href="english/oeuvre/eco/oeko_humustoilette.php">Humus toilet and the biological purification plant</a></li>
        </ul>
  </ul>
