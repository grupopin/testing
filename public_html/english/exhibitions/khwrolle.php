...
<head>
<title>The Role of KunstHausWien &middot; Hundertwasser</title>
...
<script type="text/javascript">
	...
	picdesc[0]= "<h2>KunstHausWien, Vienna, 1989-1991</h2>Photo: Peter Strobl";	
	picdesc[1]= "";	
	picdesc[2]= "";	

	var picpath = new Array();
	picpath[0]= "english/exhibitions/images/khw/kunsthaus3.jpg";	
	picpath[1]= "english/exhibitions/images/khw/apa_0006_1_big.jpg";	
	picpath[2]= "english/exhibitions/images/khw/default.htm";	
...
<div id="navigation">
  ...
  <div id="nav_ballDiv"><img src="interface/largemenu/ball_3_b.png" width="44" height="39" alt="" /></div>
	<div id="nav_titDiv"><a href="english/exhibitions/index.php"><img src="interface/largemenu/title_e_3.png" width="245" height="37" alt="" /></a></div>
...
<div id="contentwrapper">
	...
	<div id="content">
	<h2>The Role of KunstHausWien</h2>
		<div class="newsItem alternative">
		<p><a href="javascript:showPic(0)"><img src="images/khw/khw_rolle_1.jpg" alt=""></a></p>
	<p>
	The architecture of KunstHausWien would be a bastion against the dictatorhip of the straigth line,
	the ruler and T-square, a bridgehead against the grid system and the chaos of the absurd.
	</p>
	<p>
	Art must meet man's and nature's pace. Art must respect nature and the laws of nature.
	Art must respect man and man's inspiration for true and durable values. Art must again be a bridge
	between the creativity of nature and the creativity of man. Art must regain its universal function
	for all and not be just a fashionable business for insiders.
	</p>
		<p>
		<span><a href="javascript:showPic(1)"><img src="interface/white/gr4.png" alt="image" width="78" height="106" /></a></span> 	
	...
	The task of KunstHausWien is to achieve these goals.</p>
	</p>
		<p>
		<em>Hundertwasser, October, 1990</em>
		</p></div>
...
<div id="containerRight">
	<p><a href="english/exhibitions/index.php">Exhibitions</a></p>
	<ul>
<li><a href="english/exhibitions/hw_im_khw.php">Hundertwasser at KunstHausWien</a><ul><li class="active"><a href="english/exhibitions/khwrolle.php">The Role of KunstHausWien</a></li><li><a href="english/exhibitions/khwhaut.php">The Third Skin in the Third District</a></li><li><a href="english/exhibitions/khwboden.php">The Uneven Floor</a></li><li><a href="english/exhibitions/hundertwasser-ausstellung.php">The Permanent Hundertwasser Exhibition</a></li></ul></li><li><a href="english/exhibitions/ausstellungsprogramm.php">Exhibitions Programme</a></li><li><a href="english/exhibitions/Wc1ec4d289f31c.htm">Exhibitions Archive</a></li> 
	</ul>
</div> <!-- /containerRight -->
</div> <!-- /wrapper -->
