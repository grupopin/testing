...
<head>
<title>Hundertwasser Manifestos and Texts &middot; Hundertwasser</title>
...
<script type="text/javascript">
	...
	picdesc[1]= "<h2>Hundertwasser with gigant puriri tree in Kaurinui Valley, New Zealand</h2><br>Photo: Alfred Schmid";	

	var picpath = new Array();
	picpath[1]= "english/texts/images/hundertwasser/philo/texte_cover.jpg";	
...
<div id="contentwrapper">
	...
	<div id="content">
	<h2>Hundertwasser Manifestos and Texts</h2>
	
 	<div class="newsItem alternative">
 	<p><a href="javascript:showPic(1)"><img src="images/hundertwasser/philo/texte_cover_sml.jpg" width="400" height="264" alt=""></a></p>
 	<p>…Hundertwasser’s thoughts are a philosophy of the aesthetic, the life  and art in harmony with nature. Mostly the texts were devised and  written for special occasions or individual concerns. The publications  appeared singular and texts were distributed differently. Hundertwasser  saw himself not as a writer but rather as a thinker.</p>
 	<p>&nbsp;</p>
 	<p>Since his first artistic actions his thoughts circulate around the same  topics: life, nature and all beauty, what happens between, next to  function and profit. It attracts attention that the texts were  cumulative subdivided, more targeted and gets more profoundness by and  by. They obey not the trends, the rumour of the public and the exchange  value, they owe their appearance the diligently and exact study of  humans and their manifold interdependences and addictions, necessities  and opportunities, but also their lapses…</p>
 	
	<p class="reference">Walter Schurian, in:<br />
Friedensreich Hundertwasser, Schöne Wege, Gedanken über Kunst und Leben [Beautiful Paths, Thoughts on Art and Life]<br />
Writings 1943 - 1999, Munich 2004 (translation from German)</p>
	</div>
	
	<dl class="points">
	  <dt class="point3"><img src="interface/spacer.gif" width="250" height="1" alt=""></dt>	

	  <dt class="point3">	
    <table border="0">
    <tr>
    <td style="width: 60px;"><img src="interface/text_icon_02.png" width="48" height="48" alt=""></td>
    <td><a href="english/texts/philo_verschimmelungsmanifest.php">Mouldiness Manifesto against Rationalism in Architecture</a><a href="english/texts/philo_verschimmelungsmanifest.php"></a></td>
    </tr>
    </table>
    </dt>
    ...
    <table>
    <tr>
    <td><a href="english/texts/philo_fensterdiktatur.php">Window Dictatorship and Window Rights</a><a href="english/texts/philo_fensterdiktatur.php"></a></td>
    <td style="width: 60px;" align="right"><img src="interface/text_icon_02.png" width="48" height="48" alt=""></td>
    </tr>
    </table>
    </dt>
    ...
    <table>
    <tr>
    <td style="width: 60px;"><img src="interface/text_icon_01.png" width="48" height="48" alt=""></td>
    <td><a href="english/texts/philo_misstaende.php">There Are No Evils in Nature. There Are Only Evils of Man.</a><a href="english/texts/philo_misstaende.php"></a></td>
    </tr>
    </table>
    </dt>
...
<div id="containerRight">
	...
	<ul>
    	<li><a href="english/texts/philo_verschimmelungsmanifest.php">Mould Manifesto</a></li>
    	<li><a href="english/texts/philo_fensterdiktatur.php">Window Dictatorship and Window Rights</a></li>
    	<li><a href="english/texts/philo_misstaende.php">There Are No Evils in Nature</a></li>
    </ul>
</div>
