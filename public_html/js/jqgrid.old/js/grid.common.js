...
function createModal(aIDs, content, p, insertSelector, posSelector, appendsel) {
	...
	var mh = jQuery('<div id="'+aIDs.modalhead+'"><table width="100%" border=0><tbody><tr><td class="modaltext">'+p.caption+'</td> <td style="text-align:right" ><a href="javascript:void(0);" class="jqmClose">'+(clicon!=''?'<img src="' + clicon + '" border="0"/>':'X') + '</a></td></tr></tbody></table> </div>').addClass("modalhead");
