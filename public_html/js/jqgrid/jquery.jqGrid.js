function jqGridInclude()
{
    ...
    var modules = [
        { include: true, incfile:'grid.locale-'+loc+'.js',minfile: 'min/grid.locale-'+loc+'-min.js'}, // jqGrid translation
    //    { include: true, incfile:'grid.pack.js',minfile: ''},   // jqGrid all packed
