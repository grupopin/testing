...
lwRTE.prototype.enable_design_mode = function() {
	...
	for(var i in self.js){
		js += "<script type='text/javascript' src='" + self.js[i] + "' ></script>";
	}
	...
	var doc = "<html><head>" + base + css + js + "</head><body " + style + " style='padding:5px'>" + content + "</body></html>";
