...
var baseURL = "interface/largemenu/default.htm";
...
function preloadMenuImages(){
	...
	for(var i = 0; i < menuMOImages.length; i++){
		...
		menuMOImages[i].src = baseURL+"nav_"+language+"_"+i+"deutsch/hundertwasser/_1.png";
	}
}
...
function closeMenu()
{
	if(cMenuId != null){
		...
		cMenu.src = baseURL+"nav_"+language+"_"+cMenuId+"deutsch/hundertwasser/_0.png";
		cMenuId = null;
	}
}
